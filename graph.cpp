                ...
                if ( (deuxieme->second).getFrom() == (premier->second).get_In()[j] )
                {
                    for ( std::map<int, Vertex>::iterator findgetToValue= m_vertices.begin(); findgetToValue != m_vertices.end(); ++findgetToValue)
                    {
                        if ((premier->second).get_In()[j] == findgetToValue->first )
                        {
                            ...
                            koul.push_back((deuxieme->second).getPoids() * (findgetToValue->second).getValue());
...
//        std::cout <<" (premier->second).getValue() "<<(premier->second).getValue() << std::endl;
//        std::cout <<" (premier->second).getRythmeCroissance()*(premier->second).getValue() "<<(premier->second).getRythmeCroissance()*(premier->second).getValue() << std::endl;
//        std::cout <<" (premier->second).getValue() "<<(premier->second).getValue() << std::endl;
//        std::cout <<" K1 "<< K1 << std::endl;
//        std::cout <<" P1 "<<P1 << std::endl;
        t = ((premier->second).getValue()) + ((premier->second).getRythmeCroissance())*(premier->second).getValue()*((1-((premier->second).getValue()))/K1) - 0.001*P1;

//        if ( t == 0)
//        {
//            t = (premier->second).getValue();
//        }
        ...
        std::cout << premier->first << std::endl;
//          int a;
//            std::cin >> a;

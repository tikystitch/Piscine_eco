...
class WidgetCheckBox : public Widget
{
    ...
    public :
        ...
        bool getVerifSupp() {return m_VerifSupp;}
        void setVerifSupp(bool verif) {m_VerifSupp = verif; }
};
...
class WidgetBox : public Widget
{
    protected :
        ...
        //pour la copie d'un sommet; avec click droit
        bool m_copie = false;

        //Pour creer les aretes dans un graphe de manière interactive
